...
public class App {
    ...
    private static void gestisciDispositivo(TechRehab techRehab, Scanner scanner) {
        int scelta;
        do {
            System.out.println("Menu:");
            ...
            switch (scelta) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    rimuoviDispositivo(techRehab, scanner);
                    break;
                case 0:
    ...
    private static void inserisciDispositivo(TechRehab techRehab, Scanner scanner) {
        ...
        try {
            ...
            // Puoi gestire diversi tipi di eccezioni a seconda delle tue esigenze.
        }
    }
    ...
    private static void rimuoviDispositivo(TechRehab techRehab, Scanner scanner) {
        System.out.print("Inserisci il seriale del dispositivo da rimuovere: ");
        String seriale = scanner.next();
        techRehab.rimuoviDispositivo(seriale);
    ...
    private static void emettiPreventivo(TechRehab techRehab, Scanner scanner) {
        ...
        while (true) {
            ...
            String risposta = scanner.next().toUpperCase(); // Converte in maiuscolo per gestire "Y" e "N"
    ...
    private static void definisciPriorita(TechRehab techRehab, Scanner scanner) {
        ...
        boolean priorita = scanner.nextBoolean();
